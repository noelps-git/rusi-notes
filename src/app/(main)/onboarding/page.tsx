            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  maxLength={20}
                  className="w-full pl-12 pr-12 py-3 bg-[#2A2A2A] border border-[#333333] rounded-[100px] text-white placeholder-[#666666] focus:outline-none focus:border-[#e52020] transition-all caret-white"
                  required
                />
                {/* Status Icon */}
