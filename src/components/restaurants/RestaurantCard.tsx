...
export function RestaurantCard({ restaurant }: RestaurantCardProps) {
  ...
  return (
    <Link href={`/restaurants/${restaurant.id}`}>
      <div className="group bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover-lift cursor-pointer transition-all duration-300 hover:shadow-lg">
