          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-[#0009FF]/20 rounded-full flex items-center justify-center">
                <BarChart3 className="w-5 h-5 text-[#0009FF]" />
              </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-white mb-2">
                Question <span className="text-[#0009FF]">*</span>
              </label>
              <input
                type="text"
                value={question}
            ...
            <div>
              <label className="block text-sm font-medium text-white mb-2">
                Options <span className="text-[#0009FF]">*</span>
                ...
                {options.map((option, index) => (
                  <div key={index} className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2 bg-[#111111] border border-[#333333] rounded-lg text-white placeholder-[#666666] focus:outline-none focus:border-[#0009FF] transition-all"
                    />
                    {options.length > 2 && (
                      <button
                        type="button"
              ...
              {options.length < 10 && (
                <button
                  ...
                  className="mt-3 flex items-center gap-2 px-4 py-2 text-[#0009FF] hover:bg-[#0009FF]/10 rounded-lg transition-all text-sm font-medium"
                >
                  <Plus size={16} />
                  Add Option
                </button>
            ...
            <div>
              <label className="flex items-center gap-2 mb-3">
                <input
                  ...
                  className="w-4 h-4 accent-[#0009FF]"
                />
              ...
              {hasExpiry && (
                <div className="flex items-center gap-3">
                  <input
                    ...
                    min="1"
                    max="168"
                    className="w-24 px-4 py-2 bg-[#111111] border border-[#333333] rounded-lg text-white focus:outline-none focus:border-[#0009FF] transition-all"
                  />
