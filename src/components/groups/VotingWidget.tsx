  ...
  return (
    <div className="bg-[#1E1E1E] border border-[#333333] rounded-2xl p-5 my-3 max-w-md">
      ...
      <div className="flex items-start gap-3 mb-4">
        <div className="w-10 h-10 bg-[#0009FF]/20 rounded-full flex items-center justify-center flex-shrink-0">
          ...
          return (
            ...
            >
              ...
              >
                ...
                {hasVoted && (
                  <div
                    className="absolute inset-0 bg-[#0009FF]/10 transition-all duration-300"
                ...
                <div className="relative flex items-center justify-between">
                  <div className="flex items-center gap-2 flex-1">
                    {isSelected && (
                      <CheckCircle className="w-4 h-4 text-[#0009FF] flex-shrink-0" />
                    )}
                    <span className="text-sm text-white">{option.text}</span>
                  </div>
                  {hasVoted && (
                    <span className="text-xs font-medium text-[#0009FF] ml-2">
                      {percentage}%
                    </span>
                  )}
                </div>
